...
if True: #STARTDOCUMENTATION::
    ...
    from utilities import fromtimestring, totimestring, timeticks
    ...
    from containers import Histogram, histogramInteger, HistogramNonUniform, HistogramCategorical
    ...
    from containers import InspectTable, inspect
